                ...
                for first_layout_obj in page_layout:
                    if isinstance(first_layout_obj, LTTextContainer) or isinstance(first_layout_obj, LTTextLine):
                        for line in first_layout_obj:
                            keyword_coordinates_in_line = self.get_coordinates_of_keyword(text_line_object=line,
                                                                                          keywords_list=keywords_list)
                            if keyword_coordinates_in_line is not None:
                                for x0, y0, x1, y1 in keyword_coordinates_in_line:
                                    ...
                                    for second_layout_obj in page_layout:
                                        if isinstance(second_layout_obj, LTTextContainer):
                                            ...
                                            for line in second_layout_obj:
                                                if isinstance(line, LTTextLine) or isinstance(line,
